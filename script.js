...
function CapturedPieces() {
  const black = document.querySelector(".captured-black"),
    white = document.querySelector(".captured-white");

  black.innerHTML = "";
  white.innerHTML = "";

  capturedTry.map((piece) => {
    piece.player === "WHITE"
      ? (white.innerHTML += Shape.shape(
          piece.player.toLowerCase(),
          piece.type.toLowerCase()
        ))
      : (black.innerHTML += Shape.shape(
          piece.player.toLowerCase(),
          piece.type.toLowerCase()
        ));
  });
